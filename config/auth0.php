...
return [
    ...
    'guards' => [
        ...
        'web' => [
            ...
            Configuration::CONFIG_COOKIE_SECRET => Configuration::get(Configuration::CONFIG_COOKIE_SECRET, env('AUTH0_COOKIE_SECRET', env('APP_KEY'))),
            Configuration::CONFIG_REDIRECT_URI => Configuration::get(Configuration::CONFIG_REDIRECT_URI, env('AUTH0_REDIRECT_URI', rtrim((string) env('APP_URL', ''), '/').'/callback')),
